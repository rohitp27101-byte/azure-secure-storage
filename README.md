...
![Storage Account Created](screenshots/storage-account-created.png)
...
![Blob Container Setup](screenshots/blob-container-setup.png)
![Project Files Uploaded](screenshots/project-files.png)
...
![RBAC Role Assigned](screenshots/rbac-role-assigned.png)
